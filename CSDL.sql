...
create TABLE terms(
  ...
  terms_description 	VARCHAR(255) 	NOT NULL,
...
CREATE table vendors(
  ...
  vendor_zip_code 		VARCHAR(255)	NOT NULL,
  vendor_phone 			VARCHAR(255),
  vendor_contact_last_name			VARCHAR(255),
  vendor_contact_first_name 		VARCHAR(255),
  default__terms_id			INTEGER 		REFERENCES terms(terms_id),
  default__account_number	INTEGER 		REFERENCES general_ledger_accounts(account_number)
 )
...
CREATE TABLE invoice_line_items (
  ...
  account_number          	INTEGER            REFERENCES general_ledger_accounts (account_number),
